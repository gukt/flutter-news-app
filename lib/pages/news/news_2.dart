...
class NewsPage2 extends StatelessWidget {
  const NewsPage2({Key? key}) : super(key: key);
  ...
  _buildMore(BuildContext context) {
    return Column(
      children: <Widget>[
        ListTile(
          contentPadding: EdgeInsets.all(20.w),
          title: Text('More in lifestyle', style: context.h4),
          trailing: Text('Show All', style: context.linkText),
        ),
        // TODO 原来这个也有 panding，仔细研究一下，可以细化我自定义的 widget
